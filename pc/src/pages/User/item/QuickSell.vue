...
import Details from './SettlementDetails/Details.vue';
    ...
    <div class="card-box" v-if="page">
      ...
      <div class="table-wrap">
        <div class="select-wrap">
          ...
          <a-input placeholder="商品编号和名称"></a-input>
          <button class="btn">搜索</button>
        </div>
        <a-table class="" :columns="columns" :data-source="dataSource"></a-table>
        <p> <a-checkbox v-model:checked="checked">全选</a-checkbox>
          竞买未发货总数：3项
          已选：0项
        </p>
        <div class="bbtn"><button>撤销所有已选</button><button>一键转卖</button></div>
        <p class="red">收藏证书不可委托，包含收藏证书的商品一键转卖后，证书费用将退还到您的账户余额中</p>
        <div class="bbtn">
          <button @click="details">测试查看详情</button>
        </div>
      </div>
    </div>
