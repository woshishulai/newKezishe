...
import { options1, JingMaiStatusList, JingMaiColumns, JingMaiDataSource, ShippingStatusList, ShippingColumns, ShippingDataSource, ShippingColumnsJieSuan, ShippingDataSourceJieSuan } from "./data"
...
watchEffect(() => {
    statusList.value = params.value.titleCate == list[0].cate || params.value.titleCate == undefined ? JingMaiStatusList : ShippingStatusList;
    columnsList.value = params.value.titleCate == list[0].cate || params.value.titleCate == undefined ? JingMaiColumns : ShippingColumns;
    dataSourceList.value = params.value.titleCate == list[0].cate || params.value.titleCate == undefined ? JingMaiDataSource : ShippingDataSource;
            ...
            <show-modal ref="showModals" :titleList="list" :statusList="statusList">
                <template v-slot:active3>
                    <div class="search-cate" v-if="params.titleCate == '竞买'">
                        <a-select ref="select" class="item" placeholder="所有时间" v-model:value="value1" :options="options1"
                            @change="handleChange"></a-select>
                        <a-select ref="select" class="item" placeholder="全部状态" v-model:value="value1" :options="options1"
                            @change="handleChange"></a-select>
                    ...
                    <div class="search-cate" v-else>
                        ...
                        <a-input v-model:value="value" style="width: 316px;" placeholder="名称/藏品/合同号" />
